...
<body>
	...
	<script>
		...
		$(".move").on("click", function(e){
			...
			let authorId = $(this).attr("href"); //a태그 속성에 저장된 데이터로 초기화
			let authorName= $(this).data("name"); //a태그 속성에 저장된 데이터로 초기화
			
			/*부모요소(goodsEnroll.jsp)에 접근하여 각 input태그에 authorId/Name변수의 값을 삽입*/
