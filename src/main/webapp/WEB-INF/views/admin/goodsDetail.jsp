...
<link rel="stylesheet"
	href="../resources/css/admin/goodsDetail.css?after">
...
<body>
		...
		<div class="admin_content_main">
			...
			<div class="form_section">
				...
				<div class="form_section_content">
					<input name="workName"
						value="<c:out value="${goodsInfo.workName}"/>" disabled>
				</div>
			</div>
			<div class="form_section">
				<div class="form_section_title">
			...
			<div class="form_section">
				...
				<div class="form_section_content">
					<input name="exhibitYear" autocomplete="off" readonly="readonly"
						value="<c:out value="${goodsInfo.exhibitYear}"/>" disabled>
				</div>
			</div>
			<div class="form_section">
				<div class="form_section_title">
				...
				<div class="form_section_content">
					<input name="exhibiter"
						value="<c:out value="${goodsInfo.exhibiter}"/>" disabled>
				</div>
			</div>
			<div class="form_section">
				<div class="form_section_title">
			...
			<div class="form_section">
				...
				<div class="form_section_content">
					<input name="workPrice"
						value="<c:out value="${goodsInfo.workPrice}"/>" disabled>
				</div>
			</div>
			<div class="form_section">
				<div class="form_section_title">
				...
				<div class="form_section_content">
					<input name="workStock"
						value="<c:out value="${goodsInfo.workStock}"/>" disabled>
				</div>
			</div>
			<div class="form_section">
				<div class="form_section_title">
			...
			<div class="form_section">
				...
				<div class="form_section_content bit">
					<textarea name="workIntro" id="workIntro_textarea" disabled>${goodsInfo.workIntro}</textarea>
				</div>
			</div>
			<div class="form_section">
				<div class="form_section_title">
				...
				<div class="form_section_content bct">
					<textarea name="workContents" id="workContents_textarea" disabled>${goodsInfo.workContents}</textarea>
				</div>
			</div>
			<div class="form_section">
                    			<div class="form_section_title">
	...
	<script>
		$(document).ready(function() {
			/* 할인율 값 삽입 */
			let workDiscount = '<c:out value="${goodsInfo.workDiscount}"/>' * 100;
			$("#discount_interface").attr("value", workDiscount);
			/* 카테고리 */
			...
			$.getJSON("/getAttachList", {workId : workId}, function(arr){	
				...
				str += ">";
				//ResponseEntity(httpheader&httpbody를 포함)사용하여 display사용
		...
		$("#modifyBtn").on("click", function(e){
			e.preventDefault();
			let addInput = '<input type="hidden" name="workId" value="${goodsInfo.workId}">';
