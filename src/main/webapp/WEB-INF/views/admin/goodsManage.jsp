...
<link rel="stylesheet"
	href="../resources/css/admin/goodsManage.css?after">
...
<body>
			...
			<c:if test="${listcheck != 'empty'}">
				<table class="goods_table">
					...
					<c:forEach items="${list}" var="list">
						<tr>
							<td>
								<a class="move" href='<c:out value="${list.workId}"/>'> 
									<c:out value="${list.workId}"></c:out>
								</a>
							</td>
							<td><c:out value="${list.workName}"></c:out></td>
							<td><c:out value="${list.authorName}"></c:out></td>
							<td><c:out value="${list.cateName}"></c:out></td>
							<td><c:out value="${list.workStock}"></c:out></td>
	...
	<script>
		...
		$(".move").on("click", function(e){
			...
			moveForm.append("<input type='hidden' name='workId' value='"+$(this).attr("href") + "'>");
