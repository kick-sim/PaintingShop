			...
			<div class="wrap">
				...
				<div class="mail_wrap">
					...
					<div class="mail_check_wrap">
						<!-- 인증번호가 일치하면 초록색 correct 일치하지 않으면 빨간색 incorrect가 되도록 아래 함수에서 설정 -->
	...
	<script>
		...
		$(".mail_check_button").click(function() {
			...
			$.ajax({
				...
				type : "GET",
				url : "mailCheck?email=" + email, // get방식 데이터 전송
				success : function(data) {
					//console.log("data : " + data);
					cehckBox.attr("disabled", false);
					boxWrap.attr("id", "mail_check_input_box_true");//id를 수정함으로써 다른 css가 입혀져 색깔 바꿈
					code = data;
				}
			...
			new daum.Postcode(
					{
						oncomplete : function(data) {
							...
							$(".address_input_1").val(data.zonecode);//zonecode는 js api에서 넘어오는 우편번호이다
