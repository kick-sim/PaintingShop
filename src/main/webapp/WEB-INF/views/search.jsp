					...
					<c:if test="${listcheck != 'empty'}">
						...
						<div class="search_filter">
							...
							<form id="filter_form" action="/search" method="get">
								<input type="hidden" name="keyword"> <input
									type="hidden" name="cateCode"> <input type="hidden"
									name="type">
							</form>
						</div>
										...
										<tr>
											<td class="image">
												<div class="image_wrap"
													data-workid="${list.imageList[0].workId}"
											...
											<td class="detail">
												...
												<div class="title">
													<a href="/goodsDetail/${list.workId}">
													${list.workName}
													 </a>
												</div>
												<div class="author">${list.authorName}지음|
													${list.exhibiter} | ${list.exhibitYear}</div>
											</td>
											<td class="info">
											...
											<td class="price">
												<div class="org_price">
													<del> ${list.workPrice} </del>
												</div>
												<div class="sell_price">
													<strong> <c:out
															value="${list.workPrice * (1-list.workDiscount)}" />
													</strong>
												</div>
											</td>
											<td class="option"></td>
			...
			$(document)
					.ready(
							function() {
								...
								/* 이미지 삽입 .imgage_wrap이 여러개일때 모두 호출*/
								$(".image_wrap")
										.each(
												function(i, obj) {//i는 index이고 obj는 그 순서의 객체
